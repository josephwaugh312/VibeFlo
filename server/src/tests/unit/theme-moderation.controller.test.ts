...
describe('Theme Moderation Controller', () => {
  ...
  describe('getPendingThemes', () => {
    ...
    it('should return pending themes when successful', async () => {
      const mockThemes = [
        { id: 1, name: 'Theme 1', moderation_status: 'pending' },
        { id: 2, name: 'Theme 2', moderation_status: 'pending' }
      ];
      ...
      await getPendingThemes(mockRequest as Request, mockResponse as Response);
    ...
    it('should handle database errors', async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith({ message: 'Server error getting pending themes' });
    });
  });
  ...
  describe('approveTheme', () => {
    ...
    it('should approve a theme when successful', async () => {
      ...
      await approveTheme(mockRequest as Request, mockResponse as Response);
  ...
  describe('rejectTheme', () => {
    ...
    it('should reject a theme when successful', async () => {
      ...
      await rejectTheme(mockRequest as Request, mockResponse as Response);
  ...
  describe('reportTheme', () => {
    ...
    it('should report a theme successfully', async () => {
      ...
      await reportTheme(mockRequest as Request, mockResponse as Response);
  ...
  describe('getReportedThemes', () => {
    ...
    it('should return reported themes when successful', async () => {
      ...
      await getReportedThemes(mockRequest as Request, mockResponse as Response);
