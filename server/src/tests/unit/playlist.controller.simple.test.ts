...
// Define a simple test user type
interface LocalTestUser {
  id: number;
  name?: string;
  username?: string;
  email?: string;
...
// Create a mock request type for testing
type MockRequest = Partial<Request> & {
  user?: LocalTestUser;
};

// Create a simplified createPlaylist controller for testing
const simpleCreatePlaylist = (req: MockRequest, res: Response, next: NextFunction) => {
...
const simpleAddSongToPlaylist = (req: MockRequest, res: Response, next: NextFunction) => {
...
describe('Playlist Controller - Simple Tests', () => {
  ...
  describe('createPlaylist', () => {
    it('should create a playlist successfully', () => {
      // Call the controller
      simpleCreatePlaylist(mockRequest, mockResponse as Response, mockNext);
  ...
  describe('addSongToPlaylist', () => {
    ...
    it('should add a song to a playlist successfully', () => {
      // Call the controller
      simpleAddSongToPlaylist(mockRequest, mockResponse as Response, mockNext);
