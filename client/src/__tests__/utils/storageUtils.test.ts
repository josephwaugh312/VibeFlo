...
describe('Storage Utilities', () => {
  ...
  describe('StorageKeys', () => {
    it('should define all required storage keys', () => {
      ...
      expect(StorageKeys.CACHED_USER).toBeDefined();
      expect(StorageKeys.SPOTIFY_ACCESS_TOKEN).toBeDefined();
      expect(StorageKeys.VIBEFLO_PLAYLIST).toBeDefined();
      expect(StorageKeys.POMODORO_TODOS).toBeDefined();
    });
  });
